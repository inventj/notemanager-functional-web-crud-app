        ...
        stage ('Deploy') {
           steps {
               sh '''
                  ...
                  '''
               sh 'ssh -o StrictHostKeyChecking=no -t -t -i /data/jenkins.pem jenkins@ec2-18-197-144-95.eu-central-1.compute.amazonaws.com "java -jar /data/notes/notemanager-api-1.0-SNAPSHOT.jar &"'
            }
        }
    }
}
