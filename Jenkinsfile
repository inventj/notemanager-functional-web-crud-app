        ...
        stage ('Deploy') {
           steps {
               sh '''
                  ...
                  '''
               sh 'ssh -o StrictHostKeyChecking=no -t -t -i /data/jenkins.pem jenkins@ec2-18-197-144-95.eu-central-1.compute.amazonaws.com "ps -ef | grep java;java -jar /data/notes/notemanager-api-1.0-SNAPSHOT.jar &;echo started;ps -ef | grep java"'
            }
        }
    }
}
